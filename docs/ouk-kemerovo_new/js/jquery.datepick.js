...
function Datepicker() {
	...
	this.regional[''] = { // US/English
		...
		prevText: '&lt; назад', // Text for the previous month command
		prevStatus: 'Показать предыдущий месяц', // Status text for the previous month command
		prevJumpText: '&lt;&lt;', // Text for the previous year command
		prevJumpStatus: 'Показать предыдущий год', // Status text for the previous year command
		nextText: 'вперед &gt;', // Text for the next month command
		nextStatus: 'Показать следующий месяц', // Status text for the next month command
		nextJumpText: '&gt;&gt;', // Text for the next year command
		nextJumpStatus: 'Показать следующий год', // Status text for the next year command
		currentText: 'Текущий', // Text for the current month command
		currentStatus: 'Показать текущий месяц', // Status text for the current month command
		todayText: 'сегодня', // Text for the today's month command
		todayStatus: 'Показать сегодняшний день', // Status text for the today's month command
		clearText: 'Clear', // Text for the clear command
		clearStatus: 'Clear all the dates', // Status text for the clear command
		closeText: 'Close', // Text for the close command
		closeStatus: 'Close the datepicker', // Status text for the close command
		yearStatus: 'Выбрать год', // Status text for year selection
		monthStatus: 'Выбрать месяц', // Status text for month selection
		weekText: 'Wk', // Text for week of the year column header
		weekStatus: 'Week of the year', // Status text for week of the year column header
		dayStatus: 'Выбрать DD, M d, yyyy', // Status text for selectable days
		defaultStatus: 'Выбрать дату', // Status text shown by default
