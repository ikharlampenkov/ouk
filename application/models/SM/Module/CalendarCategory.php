 ...
 *
 ...
 ALTER TABLE calendar_category
   OWNER TO garage;
 COMMENT ON TABLE calendar_category
   IS 'Таблица категорий календаря';
 */

/**
 * Class SM_Module_CalendarCategory
 */
...
class SM_Module_CalendarCategory
{
    ...
    {
        try {
            $sql = 'INSERT INTO calendar_category(title, date_create) VALUES(:title, :date_create)';
    ...
    {
        try {
            $sql = 'DELETE FROM calendar_category WHERE id=:id';
    ...
    {
        try {
            $sql = 'SELECT * FROM calendar_category';
            ...
            if (isset($result[0])) {
                ...
                foreach ($result as $res) {
                    $retArray[] = SM_Module_CalendarCategory::getInstanceByArray($res);
                }
                return $retArray;
            } else {
                return false;
     ...
     * @static
     * @param $values
     * @return SM_Module_CalendarCategory
     * @throws Exception
     */
    public static function getInstanceByArray($values)
    {
        try {
            $o = new SM_Module_CalendarCategory();
     ...
     * @static
     * @param $id
     * @return bool|SM_Module_CalendarCategory
     * @throws Exception
     */
    public static function getInstanceById($id)
    {
        try {
            $sql = 'SELECT * FROM calendar_category WHERE id=:id';
